...
# ── Import your app config + all models ───────────────────────────────────────
# Models must be imported here so Alembic can detect schema changes (autogenerate).
import sys
import os
...
async def run_async_migrations() -> None:
    ...
    connectable = async_engine_from_config(
        ...
        url=settings.DATABASE_URL,     # use async URL for the engine
    )
