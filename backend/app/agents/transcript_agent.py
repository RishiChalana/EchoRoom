...
def run_transcription(session_id: str, chunk_id: str, audio_bytes: list) -> TranscriptChunk:
    model = _get_model()
    ...
    log.info("Transcript published", session_id=session_id, chunk_id=chunk_id)
    return chunk
